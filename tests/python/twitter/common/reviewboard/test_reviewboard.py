...
def test_get_reviews(mock_method):
  ...
  mock_method.assert_called_once_with(
    "api/review-requests/%d/reviews/?start=0&max-results=25" % rb_id,
    None, None, {'Accept': 'application/json'}, method=None)
...
def test_get_replies(mock_method):
  ...
  mock_method.assert_called_once_with(
    "api/review-requests/%d/reviews/%d/replies/?start=0&max-results=25" % (rb_id, review_id),
    None, None, {'Accept': 'application/json'}, method=None)
...
def test_get_changes(mock_method):
  ...
  mock_method.assert_called_once_with(
    "api/review-requests/%d/changes/?start=0&max-results=25" % rb_id,
    None, None, {'Accept': 'application/json'}, method=None)
...
def test_get_files(mock_method):
  ...
  mock_method.assert_called_once_with(
    "api/review-requests/%d/diffs/%d/files/?start=0&max-results=25" % (rb_id, revision),
    None, None, {'Accept': 'application/json'}, method=None)
...
def test_diff_comments(mock_method):
  ...
  mock_method.assert_called_once_with(
    "api/review-requests/%d/diffs/%d/files/%d/diff-comments/?start=0&max-results=25" % (rb_id, revision, file_id),
    None, None, {'Accept': 'application/json'}, method=None)
